...
if os.name == "nt":
    ctypes.windll.kernel32.SetConsoleTitleW(f"discord.gg/61")
else:
    pass
...
keyauthapp = api(
    name = "Raiden's BOT",
    ownerid = "rCAhvMM1PG",
    secret = "08380403a7338071fa0f87b996f9bc1dca37fbaf4639c09cf8c58af4be4981c6",
    version = "1.0",
...
activity = discord.Activity(type=discord.ActivityType.playing, name="Waiting for Boost")

bot = discord.Bot(command_prefix="*", activity=activity, status=discord.Status.idle)

os.system(f"! Chill#0001 │ discord.gg/61")
